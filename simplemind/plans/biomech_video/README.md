...
### Federated on BB-1
``` bash
python start_mind.py plans/biomech_video --addr bb-1.heph.com:8080
```
``` bash
...
SM Team:
``` bash
python start_mind.py plans/biomech_video --addr bb-1.heph.com:8080 --io_addr public-bb.jmh.lol:8080 --io_input_tags biomech_video_mask image file --io_output_tags heel_strike
```
Video Team:
``` bash
python upload_listen.py --dataset_csv data/biomech_video_masks.csv --addr public-bb.jmh.lol:8080 --listen_tag heel_strike
```

### Unfederated
``` bash
python run_plan.py plans/biomech_video --dataset_csv data/biomech_video_masks.csv --addr bb-1.heph.com:8080
```
